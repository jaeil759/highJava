...
//		File file1 = new File("d:/D_other/test.txt");
		...
		// 디렉토리(폴더) 만들기
		/*
		 * - mkdir ==> makedirectory  ==> File객체의 경로중에서 마지막 위치의 디렉토리를 만든다.
		 * 							  ==> 반환값 : 만들기성공 : true, 만들기 실패 : false
		 * 							  ==> 중간부분의 경로가 모두 만들어져 있어야 마지막 위치의 경로를 만들 수 있다.
		 * - mkdirs ==> 중간 부분의 경로가 없으면 중간 부분의 경로도 같이 만들어 준다.
		 			==> 반환값 : 만들기성공 : true, 만들기 실패 : false
		*/
		File file5 = new File("d:/d_Other/연습용");
		System.out.println("file5의 이름 : " + file5.getName() + " 의 존재여부 : " + file5.exists());
