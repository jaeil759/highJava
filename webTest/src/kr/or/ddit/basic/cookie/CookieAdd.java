...
public class CookieAdd extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// Cookie저장하는 방법
		// 1. Cookie객체를 생성한다 ==> '쿠키값' 과 '쿠키value값'을 문자열로 지정해서 생성한다.
		// 형식) Cookie cookie변수 = new Cookie('쿠키 key값', '쿠키 value값');
		...
		// 쿠키변수.setMaxAge(유지시간); 	==> 단위(초), (-1:브라우저가 종료될때까지 유지(기본값), 0: 즉시 삭제된다.)
		...
		out.println("<body>");
		out.println("<h3>Cookie데이터가 저장되었습니다.</h3><br><br>");
